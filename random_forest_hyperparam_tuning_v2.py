'''
Added balanced Class weight and scoring 
'''
import pandas as pd
...
forest = RandomForestClassifier(n_jobs=process_count, class_weight="balanced")
...
grid_search = RandomizedSearchCV(forest, param_grid, cv=5, scoring="balaced_accuracy", n_jobs=process_count, verbose=3, return_train_score=True)
